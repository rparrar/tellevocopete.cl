...
<title>Te llevo Copete? - Pisco</title>
</head>
<body>
  				...
  				<ul class="dropdown-menu" role="menu">
					...
					<a class="btn btn-danger" href="otros.php" role="button">OTROS</a>
			  		...
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/pisco/2-mistral-750.jpg" alt="Pisco Mistral 35º 750CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Pisco Mistral 35º 750 CC</p>
			  		...
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/pisco/1-altodelcarmen-1000.jpg" alt="Pisco Alto del Carmen 1000 CC." class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Pisco Alto del Carmen 35º 1000 CC.</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 8.500</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/pisco/3-fundolosnichos-750.jpg" alt="Pisco Fundo Los Nichos 35º 750 CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Pisco Fundo Los Nichos 35º 750 CC.</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 10.000</p>
				    		</div>
				    	</div>
			  		</div>
