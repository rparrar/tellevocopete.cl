...
<title>Te llevo Copete? - Zonas de Reparto y Precios</title>
</head>
<body>
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  		...
  		<ul class="nav navbar-nav navbar-right">
  			<li class="dropdown">
        		...
        		<ul class="dropdown-menu">
        		  ...
        		  <li><a href="otroslicores.php"><i class="verde fa fa-gift"><span class="happy verde"> Otros</span></i></a></li>	
	...
	<div class="mas-espacio-arriba text-center azul"><br><h1>Zonas de Reparto - Precios</h1>
		<p class="naranjo mediano animated flash retraso-1">Nuestro Horario de Atención, Por Inauguración, es Viernes y Sábado, de las 23:00 hasta las 06:00!</p>
<div class="col-xs-10 col-sd-6 col-md-8 quitar-float centrame">
	<div class="text-center panel-group" id="accordion" role="tablist" aria-multiselectable="false">
	  
	  <div class="panel panel-default">
	    <div class="panel-heading" role="tab" id="huechuraba">
	      <h4 class="panel-title">
	        <a class="azul collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">Huechuraba - <span class="text-primary">$2.000</span></a>
	      </h4>
	    </div>
	    <div id="collapseOne" class="panel-collapse collapse" role="tabpanel" aria-labelledby="huechuraba">
	      <div class="panel-body">
	      	<img src="img/comunas/huechuraba.jpg" />
	        <p class="happy verde">En Huechuraba, repartimos desde Americo Vespucio, con Pedro Fontova Norte, hacia el Norte, pasando por todos los sectores</p>
	      </div>
	    </div>
	  </div>
	  <div class="panel panel-default">
	    <div class="panel-heading" role="tab" id="providencia">
	      <h4 class="panel-title">
	        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="true" aria-controls="collapseTwo">Providencia - <span class="text-primary">$2.500</span></a>
	      </h4>
	    </div>
	    <div id="collapseTwo" class="panel-collapse collapse" role="tabpanel" aria-labelledby="providencia">
	      <div class="panel-body">
	      		<img src="img/comunas/providencia.jpg" />
	        	<p class="happy verde">En Providencia, en toda la comuna</p>
	      </div>
	    </div>
	  </div>
	  <div class="panel panel-default">
	    <div class="panel-heading" role="tab" id="vitacura">
	      <h4 class="panel-title">
	        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseThree" aria-expanded="true" aria-controls="collapseThree">Vitacura - <span class="text-primary">$2.500</span></a>
	      </h4>
	    </div>
	    <div id="collapseThree" class="panel-collapse collapse" role="tabpanel" aria-labelledby="vitacura">
	      <div class="panel-body">
	      		<img src="img/comunas/vitacura.jpg"/>
	        	<p class="happy verde">En Vitacura, en toda la comuna</p>
	      </div>
	    </div>
	  </div>

	<div class="panel panel-default">
	    <div class="panel-heading" role="tab" id="lascondes">
	      <h4 class="panel-title">
	        <a class="collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseFour" aria-expanded="true" aria-controls="collapseThree">Las Condes - <span class="text-primary">Desde $2.000 a $3.000</span></a>
	      </h4>
	    </div>
	    <div id="collapseFour" class="panel-collapse collapse" role="tabpanel" aria-labelledby="lascondes">
	      <div class="panel-body">
	      		<img src="img/comunas/las-condes.jpg" />
	        	<p class="happy verde">En Las Condes, en toda la comuna, depende de la distancia, el precio final</p>
	      </div>
	    </div>
	  </div>
	</div>
