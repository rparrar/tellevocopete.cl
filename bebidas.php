...
<title>Te llevo Copete? - Bebidas</title>
</head>
<body>
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
	...
	<section class="text-center">
			...
			<h1 class="happy azul">BEBIDAS</h1>
			...
			<div class="col-xs-12 col-sm-12 col-md-12 barrabotones">
				<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
					...
					<a class="disabled btn btn-danger" href="bebidas.php" role="button">BEBIDAS</a>
			...
			<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/1_coca2500.jpg" alt="Coca Cola 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Cola 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/2_cocal2500.jpg" alt="Coca Light 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Light 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/3_cocaz2500.jpg" alt="Coca Zero 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Zero 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/4_fanta2500.jpg" alt="Fanta 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Fanta 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/5_sprite2500.jpg" alt="Sprite 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Sprite 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/6_ginger3000.jpg" alt="Canada Dry 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Canada Dry 1500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/1_coca2500.jpg" alt="Coca Cola 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Cola 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/2_cocal2500.jpg" alt="Coca Light 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Light 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/3_cocaz2500.jpg" alt="Coca Zero 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Coca Zero 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/4_fanta2500.jpg" alt="Fanta 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Fanta 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/5_sprite2500.jpg" alt="Sprite 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Sprite 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/6_ginger3000.jpg" alt="Canada Dry 2500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Canada Dry 2500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 3.500</p>
				   		</div>
				   	</div>
			  	</div>
			  	<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/energetica250cc.jpg" alt="Energética Score 250 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Energética Score 250 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 1.200</p>
				   		</div>
				   	</div>
			</div>
			<div class="col-xs-6 col-sm-2 col-md-2">
				   	<div class="thumbnail">
				   		<img src="img/bebidas/energetica500cc.jpg" alt="Energética Score 500 CC" class="se verde">
				   		<div class="caption">
				   			<p class="happy arreglate">Energética Score 500 CC</p>
				   			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 2.000</p>
				   		</div>
				   	</div>
			</div>
	</section>
