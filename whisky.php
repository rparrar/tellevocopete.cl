...
<title>Te llevo Copete? - Whisky</title>
</head>
<body>
				...
				<a class="btn btn-warning" href="cervezas.php" role="button">CERVEZAS</a>
					...
					<a class="btn btn-danger" href="otros.php" role="button">OTROS</a>
			  		...
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/whisky/1-ballantines-750.jpg" alt="Whisky Ballantines 750 CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Whisky Ballantines 750 CC</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 15.000</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/whisky/2-jackdaniels-750.jpg" alt="Whisky Jack Daniels 750 CC." class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Whisky Jack Daniels 750 CC.</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 25.000</p>
				    		</div>
				    	</div>
			  		</div>
