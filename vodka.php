...
<title>Te llevo Copete? - Vodka</title>
</head>
<body>
  				...
  				<ul class="dropdown-menu" role="menu">
					...
					<a class="btn btn-danger" href="otros.php" role="button">OTROS</a>
			  		...
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/vodka/1-eristoffblack-700.jpg" alt="Vodka Eristoff Black 700 CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Vodka Eristoff 700 CC</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 7.500</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/vodka/2-oz-750.jpg" alt="Vodka Oz 750 CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Vodka Oz 750 CC</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 4.500</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/vodka/3-pl-700.jpg" alt="Vodka .PL 700 CC." class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Vodka .PL 700 CC.</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 4.500</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/vodka/4-wyborowa-750.jpg" alt="Vodka Wyborowa 750 CC" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Vodka Wyborowa 750 CC</p>
				    			<p class="happy bg-info arreglate azul"><i class="fa fa-usd azul"></i> 7.500</p>
				    		</div>
				    	</div>
			  		</div>
			  		<div class="col-xs-4 col-sm-4 col-md-3">
				    	<div class="thumbnail">
				    		<img src="img/vodka/5-moroz-100ymuneca.jpg" alt="Vodka Moroz 100 CC + Muñeca Rusa de Regalo" class="se verde">
				    		<div class="caption">
				    			<p class="happy arreglate">Vodka Moroz 100 CC + Muñeca Rusa de Regalo</p>
