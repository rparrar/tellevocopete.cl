...
<title>Te llevo Copete? - SNACKS</title>
</head>
<body>
<nav class="navbar navbar-default navbar-fixed-top" role="navigation">
  			...
  			<li class="dropdown">
        		...
        		<ul class="dropdown-menu">
        		 <li><a href="licores.php"><i class="azul fa fa-video-camera fa-rotate-270"></i><span class="happy azul"> Licores - Vinos</span></a></li>	
        		  ...
        		  <li class="disabled"><a href="#"><i class="fa fa-cutlery"><span class="happy"> Para el Bajón</span></i></a></li>	        		 
        		</ul>
      		</li>
	    	<li class="dropdown">
	...
	<section class="text-center">
			...
			<div class="col-md-12"><h1 class="text-center happy azul">SNACKS-PICOTEO</h1></div>
			...
			<div class="btn-group">
  				...
  				<ul class="dropdown-menu" role="menu">
					...
					<a class="btn btn-info" href="cervezas.php" role="button">CERVEZAS</a>
					<a class="btn btn-success" href="bebidas.php" role="button">BEBIDAS</a>
					<a class="disabled btn btn-danger" href="snacks.php" role="button">SNACKS</a>
